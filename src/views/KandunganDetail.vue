  ...
  <div class="food-detail">
    ...
    <div class="container">
      ...
      <div class="row mt-4">
        <div class="col">
          <h2>
            <strong>Detail Kandungan</strong>
          </h2>
        </div>
      </div>
        ...
        <div class="col-md-6 mt-4">
          ...
          <!-- <form class="mt-4" v-on:submit.prevent>
            <div class="form-group">
              <label for="jumlah_pemesanan">Nilai kecocokan kandungan (skala 1-5)</label>
...
export default {
  ...
  mounted() {
    axios
      .get("/db.json")
      .then((response) => this.setProduct(response.data.kandungans.find(item => item.id == this.id)))
